...
class _DepartementDetailScreenState
  ...
  void _showSelectResponsableDialog(
    ...
    final boss = ref.read(fidelesByDepartementProvider(departementId));
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Sélectionnez un BOSS avec téléphone',
                              style: TextStyle(
                                fontSize: 12,
                                color: AppColors.textSecondary,
                              ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 16),
                            Text(
                              'Aucun BOSS avec numéro de téléphone',
                              textAlign: TextAlign.center,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        leading: CircleAvatar(
                          backgroundColor: AppColors.responsableColor.withAlpha(20),
                          child: Text(
                            fidele.initiales,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await _designerResponsable(context, ref, departementId, fidele);
            },
  ...
  Future<void> _designerResponsable(
    ...
    try {
      ...
      // 2. Mettre à jour le département avec le responsable
      await ref.read(departementsProvider.notifier).setResponsable(departementId, fidele.id);
